...
class SentryFlutterOptions extends SentryOptions {
  ...
  /// These bundle IDs are used to reference source code bundles that contain sources for
  /// this application. These sources will be used to provide source code for frames of
  /// an exception's stack trace.
  ///
  /// Bundle IDs are typically generated by sentry-cli or the sentry-android-gradle-plugin.
